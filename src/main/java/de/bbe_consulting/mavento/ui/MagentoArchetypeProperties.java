 ...
 * @plexus.component
 */
public class MagentoArchetypeProperties implements ArchetypeProperties {
	...
	public List<String> getRequiredProperties(
			ArchetypeGenerationRequest request, Properties commandLineProperties) throws ArchetypeNotDefined,
			UnknownArchetype, ArchetypeNotConfigured, IOException,
			PrompterException, ArchetypeGenerationConfigurationFailure {

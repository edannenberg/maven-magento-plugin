...
public interface ArchetypeProperties {

	String ROLE = ArchetypeProperties.class.getName(); 
	
	List<String> getRequiredProperties( ArchetypeGenerationRequest request, Properties commandLineProperties )

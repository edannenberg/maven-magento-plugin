...
/**
 * Uninstall a Magento Module. This goal does not need an active Maven project. <br/>
 * It will however honor the properties in your pom.xml if called from a
 * project.<br/>
 * Use -DmagentoPath=/path/to/magento to override.<br/>
 * 
 * <pre>
 * mvn magento:rmmod -DmodKey=Some_Module -DmodChannel=community -DmagentoPath=/path/to/magento/folder
 * </pre>
 * 
 * @goal rmmod
 * @aggregator false
 ...
 */
public class MagentoRmModMojo extends AbstractMagentoSimpleMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        if (!modKey.isEmpty()) {
            ...
            if (mVersion.getMajorVersion() == 1 && mVersion.getMinorVersion() <= 4) {
                ...
                params = new String[] { "uninstall", realChannel + modKey };
            } else {
                ...
                if (modKey.contains("-")) {
                    ...
                    getLog().info("Uninstalling magento-" + modChannel + "/"
                                    + modKey + "-" + extensionVersion
                                    + "..");
                    params = new String[] { "uninstall", realChannel, modKey, extensionVersion };
                } else {
                    getLog().info("Uninstalling magento-" + modChannel + "/" + modKey + "..");
                    params = new String[] { "uninstall", realChannel, modKey };
                }
            }
